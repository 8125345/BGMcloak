...
if __name__ == '__main__':
  output_dir, _ = os.path.split(FLAGS.output_model_path)
  if not os.path.isdir(output_dir):
    os.makedirs(output_dir)

  session = init_export_session()
  ret = session.estimator.export_saved_model(os.path.join(output_dir, "saved_model"), serving_input_receiver_fn)
  print(ret)
