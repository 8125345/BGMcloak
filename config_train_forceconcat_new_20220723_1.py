...
train_dataset = [
    ...
    #新加SC55和arachno音色渲染数据集
    ("xuanran", 1. * mul_times),  #trian 8478  val 942
...
basic_config = {
    "model_root": "/deepiano_data/zhaoliang/project/BGMcloak/train_output_models",
    "train_log_root": "/deepiano_data/zhaoliang/project/BGMcloak/train_log",
    "train_comment_root": "/deepiano_data/zhaoliang/project/BGMcloak/train_comment",
}
...
# 20221013
train_config = {
    "model_name": f"forceconcat_20221018_0",
    "gpuids": [2, 3],
    "train_batchsize": (512 + 512) * 2,
    "val_batchsize": (512 + 512) * 2,
    "add_maestro": True,
    "pos_weight": 1,
    "pretrain_model": "/deepiano_data/zhaoliang/project/BGMcloak/train_output_models/forceconcat_20221017_0.h5",
