...
sys.path.insert(0, '/deepiano_data/zhaoliang/project/BGMcloak')
import os
...
def run_single_schedule(dataset_type, root_path, json_dataset):
    ...
    if dataset_type == "train":
        ...
        train_save_path = os.path.join(root_path, "train_" + dataset_name + ".tfrecord")
        val_save_path = os.path.join(root_path, "val_" + dataset_name + ".tfrecord")
        dataset_info = os.path.join(root_path, "dataset_info_" + dataset_name + ".json")
        random_state_save_path = os.path.join(root_path, "random_state_" + dataset_name + ".pkl")
        ...
        print("训练数据：", train_num)
        print("训练数据校验: ", len(train_list))
...
def make_schedule():
    ...
    json_datasets = [
        ...
        # todo 以上数据bgm中可能含有钢琴音，严重影响识别
        # 20220916
        # 力军之前
        # {"name": "bgm_record_20220411_train",
        #  "path": "/deepiano_data/zhaoliang/lijun_data/json_bgm_record/bgm_record_20220411_train.json",
        #  "ratio": 1},
        # {"name": "bgm_record_20220414_train",
        #  "path": "/deepiano_data/zhaoliang/lijun_data/json_bgm_record/bgm_record_20220414_train.json",
        #  "ratio": 1},
        # {"name": "bgm_record_20220415_train",
        #  "path": "/deepiano_data/zhaoliang/lijun_data/json_bgm_record/bgm_record_20220415_train.json",
        #  "ratio": 1},
        # {"name": "bgm_record_20220420_train",
        #  "path": "/deepiano_data/zhaoliang/lijun_data/json_bgm_record/bgm_record_20220420_train.json",
        #  "ratio": 1},
        # {"name": "bgm_record_20220428_train",
        #  "path": "/deepiano_data/zhaoliang/lijun_data/json_bgm_record/bgm_record_20220428_train.json",
        #  "ratio": 1},
        # {"name": "bgm_record_20220429_train",
        #  "path": "/deepiano_data/zhaoliang/lijun_data/json_bgm_record/bgm_record_20220429_train.json",
        #  "ratio": 1},
        # {"name": "bgm_record_20220516_train",
        #  "path": "/deepiano_data/zhaoliang/lijun_data/json_bgm_record/bgm_record_20220516_train.json",
        #  "ratio": 1},
        # {"name": "bgm_record_20220517_train",
        #  "path": "/deepiano_data/zhaoliang/lijun_data/json_bgm_record/bgm_record_20220517_train.json",
        #  "ratio": 1},
        # {"name": "bgm_record_peilian_train",
        #  "path": "/deepiano_data/zhaoliang/lijun_data/json_bgm_record/bgm_record_peilian_train.json",
        #  "ratio": 1},
        # {"name": "bgm_specail_train",
        #  "path": "/deepiano_data/zhaoliang/lijun_data/json_bgm_record/bgm_specail_train.json",
        #  "ratio": 1},
        # {"name": "high-note_-20_-5_noised_train",
        #  "path": "/deepiano_data/zhaoliang/lijun_data/json_bgm_record/high-note_-20_-5_noised_train.json",
        #  "ratio": 1},
        # {"name": "single-note_-20_-5_noised_train",
        #  "path": "/deepiano_data/zhaoliang/lijun_data/json_bgm_record/single-note_-20_-5_noised_train.json",
        #  "ratio": 1},
        # # 近期录制
        # {"name": "bgm_record_20220822_train",
        #  "path": "/deepiano_data/zhaoliang/record_data/json_bgm_record/bgm_record_20220822_train.json",
        #  "ratio": 1},
        # {"name": "bgm_record_20220823_train",
        #  "path": "/deepiano_data/zhaoliang/record_data/json_bgm_record/bgm_record_20220823_train.json",
        #  "ratio": 1},
        # {"name": "bgm_record_20220824_train",
        #  "path": "/deepiano_data/zhaoliang/record_data/json_bgm_record/bgm_record_20220824_train.json",
        #  "ratio": 1},
        # {"name": "bgm_record_20220825_train",
        #  "path": "/deepiano_data/zhaoliang/record_data/json_bgm_record/bgm_record_20220825_train.json",
        #  "ratio": 1},
        # {"name": "bgm_record_20220826_train",
        #  "path": "/deepiano_data/zhaoliang/record_data/json_bgm_record/bgm_record_20220826_train.json",
        #  "ratio": 1},
        # # 纯BGM，录制
        # {"name": "negbgm_train",
        #  "path": "/deepiano_data/zhaoliang/qingchen_bgm_data/json_negbgm_record/negbgm_train.json",
        #  "ratio": 1},
        # # 纯BGM，原声
        # {"name": "negbgm_train_ori",
        #  "path": "/deepiano_data/zhaoliang/qingchen_bgm_data/json_negbgm_Original/negbgm_train.json",
        #  "ratio": 1},
        #
        # # 20220921 赵亮新生成数据
        # # 无BGM真实演奏+后处理添加BGM
        # {"name": "ai-tagging_new",
        #  "path": "/deepiano_data/zhaoliang/public_data/json_mix_public/ai-tagging_train.json",
        #  "ratio": 1},
        # {"name": "high-note_new",
        #  "path": "/deepiano_data/zhaoliang/public_data/json_mix_public/high-note_train.json",
        #  "ratio": 1},
        # {"name": "low-note_new",
        #  "path": "/deepiano_data/zhaoliang/public_data/json_mix_public/low-note_train.json",
        #  "ratio": 1},
        # {"name": "single-note_new",
        #  "path": "/deepiano_data/zhaoliang/public_data/json_mix_public/single-note_train.json",
        #  "ratio": 1},
        # {"name": "maestro_new",
        #  "path": "/deepiano_data/zhaoliang/public_data/json_mix_public/maestro-v3.0.0_train.json",
        #  "ratio": 1},  # 1

        # 20221013 新生成数据
        # xml渲染数据+后处理添加BGM
        {"name": "xuanran",
         "path": "/deepiano_data/zhaoliang/SC55_data/Alignment_data/XuanRan/json_mix_xuanran/xuanran_train.json",
         "ratio": 1},
    ...
    # dataset_name = "dataset_20220826_0"  # 去除无BGM演奏，避免召回降低，晓菲时主要数据集
    # dataset_name = "dataset_20220916_0"  # 8模型用，扩充大量新数据，+赵亮新数据，增量添加
    dataset_name = "dataset_20221013_0"  # 8模型用，生成音色渲染数据

    # 创建数据根目录
    for dataset_type in dataset_types:
        # 数据保存路径
        root_dst_folder = "/data/dataset/audio/rec_dataset/dataset_info_concat"
        folder_name = dataset_name + '_' + dataset_type  # 新数据集
